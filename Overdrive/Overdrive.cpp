...
CK_DLL_MFUN(overdrive_setParam);
CK_DLL_MFUN(overdrive_getParam);
...
CK_DLL_QUERY( Overdrive )
{
    ...
    QUERY->add_mfun(QUERY, overdrive_setParam, "float", "param");
    // example of adding argument to the above method
    QUERY->add_arg(QUERY, "float", "arg");

    // example of adding getter method
    QUERY->add_mfun(QUERY, overdrive_getParam, "float", "param");
...
CK_DLL_CTOR(overdrive_ctor)
{
    ...
    Overdrive * bcdata = new Overdrive(API->vm->get_srate());
