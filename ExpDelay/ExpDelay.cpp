...
CK_DLL_MFUN(expdelay_setParam);
CK_DLL_MFUN(expdelay_getParam);
...
CK_DLL_QUERY( ExpDelay )
{
    ...
    QUERY->add_mfun(QUERY, expdelay_setParam, "float", "param");
    // example of adding argument to the above method
    QUERY->add_arg(QUERY, "float", "arg");

    // example of adding getter method
    QUERY->add_mfun(QUERY, expdelay_getParam, "float", "param");
